...
module.exports = function (_Base) {
  ...
  function _class(props) {
    ...
    _this.state = {
      ...
      postList: [],
      keyword: '',
      page: _this.props.location.query.page / 1 || 1
    };
    return _this;
  }
  ...
  _class.prototype.componentDidMount = function componentDidMount() {
    this.listenTo(_post4.default, this.handleTrigger.bind(this));
    _post2.default.selectList(this.state.page);
  };
  ...
  _class.prototype.handleTrigger = function handleTrigger(data, type) {
    ...
    switch (type) {
      case 'savePostSuccess':
        _tip2.default.success('审核成功');
        this.setState({ loading: true }, _post2.default.selectList.bind(_post2.default, this.state.page, this.state.key === 4 ? null : this.state.key));
        break;
      case 'savePostFail':
      case 'deletePostFail':
      ...
      case 'deletePostSuccess':
        ...
        this.setState({ loading: true }, function () {
          return _post2.default.selectList(_this2.state.page);
        });
        break;
      case 'getPostList':
  ...
  _class.prototype.handleSelect = function handleSelect(key) {
    this.state.key = key;
    this.state.page = 1;
    this.state.keyword = '';

    return _post2.default.selectList(this.state.page, key !== 4 ? key : null, this.state.keyword);
  };

  _class.prototype.handleSearch = function handleSearch() {
    _post2.default.selectList(this.state.page, this.state.key !== 4 ? this.state.key : null, this.state.keyword);
  };

  _class.prototype.getPostList = function getPostList() {
    var _this3 = this;
    ...
    return this.state.postList.map(function (item) {
      return _react2.default.createElement(
        'tr',
        { key: item.id },
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          'td',
          null,
          _this3.renderStatus(item)
        ),
        _react2.default.createElement(
          'td',
          null,
          !item.create_time || item.create_time == '0000-00-00 00:00:00' ? '' : _firekylin2.default.formatTime(item.create_time)
        ),
        _this3.renderBtns(item)
      );
    });
  };
  ...
  _class.prototype.renderPostLink = function renderPostLink(post) {
  ...
  _class.prototype.renderBtns = function renderBtns(post) {
    //管理员在审核和拒绝tab上显示更多按钮
    var isAdmin = SysConfig.userInfo.type === 1;
    var showPassAndDeny = isAdmin && [1, 2, 3].includes(this.state.key);
    var showEditAndDel = !isAdmin || this.state.key === 4;
    return _react2.default.createElement(
      'td',
      null,
      showPassAndDeny ? _react2.default.createElement(
        'button',
        {
          type: 'button',
          className: 'btn btn-success btn-xs',
          disabled: [0, 3].includes(post.status),
          onClick: _post2.default.pass.bind(_post2.default, post.id)
        },
      ...
      showPassAndDeny ? _react2.default.createElement(
        'button',
        {
          ...
          onClick: _post2.default.deny.bind(_post2.default, post.id)
        },
      ...
      showEditAndDel ? _react2.default.createElement(
        _reactRouter.Link,
        { to: '/post/edit/' + post.id, title: post.title },
        _react2.default.createElement(
          'button',
        ...
        'button',
        {
          ...
          onClick: function onClick() {
            return _modal2.default.confirm('提示', _react2.default.createElement(
              ...
              { className: 'center' },
              '\u786E\u5B9A\u5220\u9664\u5417\uFF1F'
            ), _post2.default.delete.bind(_post2.default, post.id), 'modal-sm');
          }
        },
  ...
  _class.prototype.renderStatus = function renderStatus(_ref) {
    var status = _ref.status,
        is_public = _ref.is_public,
        create_time = _ref.create_time;

    var isFuture = function isFuture(time) {
    ...
    if (status !== '') {
      return _react2.default.createElement(
        ...
        is_public ? null : _react2.default.createElement('span', { className: 'glyphicon glyphicon-lock' })
      );
    }
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            ...
            onChange: function onChange(e) {
              return _this4.setState({ keyword: e.target.value });
            },
            onKeyDown: function onKeyDown(e) {
              return e.keyCode === 13 && _this4.handleSearch();
            }
          }),
          _react2.default.createElement('i', { className: 'fk-search-btn icon-search', onClick: this.handleSearch.bind(this) })
        ),
        _react2.default.createElement(
          _reactBootstrap.Tabs,
          { activeKey: this.state.key, onSelect: this.handleSelect.bind(this) },
          _react2.default.createElement(_reactBootstrap.Tab, { eventKey: 4, title: '\u5168\u3000\u90E8' }),
          _react2.default.createElement(_reactBootstrap.Tab, { eventKey: 3, title: '\u5DF2\u53D1\u5E03' }),
          _react2.default.createElement(_reactBootstrap.Tab, { eventKey: 1, title: '\u5BA1\u6838\u4E2D' }),
          _react2.default.createElement(_reactBootstrap.Tab, { eventKey: 2, title: '\u5DF2\u62D2\u7EDD' })
        ),
        _react2.default.createElement(
          'table',
        ...
        _react2.default.createElement(
          ...
          this.state.total > 1 ? _react2.default.createElement(_reactBootstrap.Pagination, {
            prev: true,
            next: true,
            first: true,
            last: true,
            ...
            onSelect: function onSelect(e, selectEvent) {
              return _this4.setState({ page: selectEvent.eventKey }, function () {
                return _post2.default.selectList(_this4.state.page, _this4.state.key === 4 ? null : _this4.state.key);
              });
            }
          }) : ''
        )
...
module.exports = {
  ...
  getComponent: function getComponent(nextState, callback) {
    callback(null, __webpack_require__(1224));
  }
};
...
module.exports = {
  path: 'list',
  getComponent: function getComponent(nextState, callback) {
    callback(null, __webpack_require__(1444));
  }
};
